...
use App\Http\Repository\Admin\Product\ZoneAreaRepository;
...
class ZoneAreaServices
{
    ...
    {
        $this->repo = new ZoneAreaRepository();
    }
    ...
    public function addAll($request){
        try {
            ...
            if(isset($last_id['ImageName'])){
                $path = Config::get('DocumentConstant.ZONESAREA_ADD');
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                if ($return_data['image']) {
                    if (file_exists_view(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image'])) {
                        removeImage(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image']);
                    }
                }
                $ImageName = $return_data['last_insert_id'] . '_' . rand(100000, 999999) . '_image.' . $request->image->extension();
                uploadImage($request, 'image', $path, $ImageName);
                $data_output = ZonesArea::find($return_data['last_insert_id']);
            ...
            if ($request->hasFile('image_two')) {
                if (isset($return_data['image_two']) && $return_data['image_two']) {
                    if (file_exists_view(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image_two'])) {
                        removeImage(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image_two']);
                    }
                }
            ...
            if ($request->hasFile('image_three')) {
                if (isset($return_data['image_three']) && $return_data['image_three']) {
                    if (file_exists_view(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image_three'])) {
                        removeImage(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image_three']);
                    }
                }
            ...
            if ($request->hasFile('image_four')) {
                if (isset($return_data['image_four']) && $return_data['image_four']) {
                    if (file_exists_view(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image_four'])) {
                        removeImage(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image_four']);
                    }
                }
            ...
            if ($request->hasFile('image_five')) {
                if (isset($return_data['image_five']) && $return_data['image_five']) {
                    if (file_exists_view(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image_five'])) {
                        removeImage(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['image_five']);
                    }
                }
            ...
            if ($request->hasFile('english_audio_link')) {
                if ($return_data['english_audio_link']) {
                    if (file_exists_view(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['english_audio_link'])) {
                        removeImage(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['english_audio_link']);
                    }
                }
            ...
            if ($request->hasFile('hindi_audio_link')) {
                if ($return_data['hindi_audio_link']) {
                    if (file_exists_view(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['hindi_audio_link'])) {
                        removeImage(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['hindi_audio_link']);
                    }
                }
            ...
            if ($request->hasFile('english_video_upload')) {
                if ($return_data['english_video_upload']) {
                    if (file_exists_view(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['english_video_upload'])) {
                        removeImage(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['english_video_upload']);
                    }
                }
            ...
            if ($request->hasFile('hindi_video_upload')) {
                if ($return_data['hindi_video_upload']) {
                    if (file_exists_view(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['hindi_video_upload'])) {
                        removeImage(Config::get('DocumentConstant.ZONESAREA_DELETE') . $return_data['hindi_video_upload']);
                    }
                }
