...
use App\Http\Repository\Admin\Product\TressRepository;
...
class TressServices
{
    ...
    //                 if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image'])) {
    //                     removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image']);
    //                 }
    //             }
    //             $ImageName = $return_data['last_insert_id'] . '_' . rand(100000, 999999) . '_image.' . $request->image->extension();
    //             uploadImage($request, 'image', $path, $ImageName);
    //             $data_output = Tress::find($return_data['last_insert_id']);
    //             $data_output->image = $ImageName;
    //             $data_output->save();
    //         }
    //         if ($request->hasFile('image_two')) {
    //             if ($return_data['image_two']) {
    //                 if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image_two'])) {
    //                     removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image_two']);
    //                 }
    //             }
    ...
    //                 if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image_three'])) {
    //                     removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image_three']);
    //                 }
    //             }
    ...
    //                 if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image_four'])) {
    //                     removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image_four']);
    //                 }
    //             }
    ...
    //                 if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image_five'])) {
    //                     removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image_five']);
    //                 }
    //             }
    ...
    //                 if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['english_audio_link'])) {
    //                     removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['english_audio_link']);
    //                 }
    //             }
    ...
    //                 if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['hindi_audio_link'])) {
    //                     removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['hindi_audio_link']);
    //                 }
    //             }
    ...
    //                 if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['english_video_upload'])) {
    //                     removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['english_video_upload']);
    //                 }
    //             }
    ...
    //                 if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['hindi_video_upload'])) {
    //                     removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['hindi_video_upload']);
    //                 }
    //             }
    ...
    public function updateAll($request) {
        try {
            ...
            if ($request->hasFile('image')) {
                if (isset($return_data['image']) && $return_data['image']) {
                    if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image'])) {
                        removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['image']);
                    }
                }
            ...
            if ($request->hasFile('english_audio_link')) {
                if (isset($return_data['english_audio_link']) && $return_data['english_audio_link']) {
                    if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['english_audio_link'])) {
                        removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['english_audio_link']);
                    }
                }
            ...
            if ($request->hasFile('hindi_audio_link')) {
                if (isset($return_data['hindi_audio_link']) && $return_data['hindi_audio_link']) {
                    if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['hindi_audio_link'])) {
                        removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['hindi_audio_link']);
                    }
                }
            ...
            if ($request->hasFile('english_video_upload')) {
                if (isset($return_data['english_video_upload']) && $return_data['english_video_upload']) {
                    if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['english_video_upload'])) {
                        removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['english_video_upload']);
                    }
                }
            ...
            if ($request->hasFile('hindi_video_upload')) {
                if (isset($return_data['hindi_video_upload']) && $return_data['hindi_video_upload']) {
                    if (file_exists_view(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['hindi_video_upload'])) {
                        removeImage(Config::get('DocumentConstant.TRESS_DELETE') . $return_data['hindi_video_upload']);
                    }
                }
