...
class AmenitiesController extends Controller {
    ...
    public function store( Request $request ) {
        ...
        $messages = [
            ...
            'image_two.max' => 'The image size must not exceed ' . Config::get( 'AllFileValidation.AMENITIES_IMAGE_MAX_SIZE' ) . ' KB.',
            'image_two.min' => 'The image size must be at least ' . Config::get( 'AllFileValidation.AMENITIES_IMAGE_MIN_SIZE' ) . ' KB.',
            ...
            'image_three.max' => 'The image size must not exceed ' . Config::get( 'AllFileValidation.AMENITIES_IMAGE_MAX_SIZE' ) . ' KB.',
            'image_three.min' => 'The image size must be at least ' . Config::get( 'AllFileValidation.AMENITIES_IMAGE_MIN_SIZE' ) . ' KB.',
            ...
            'image_four.max' => 'The image size must not exceed ' . Config::get( 'AllFileValidation.AMENITIES_IMAGE_MAX_SIZE' ) . ' KB.',
            'image_four.min' => 'The image size must be at least ' . Config::get( 'AllFileValidation.AMENITIES_IMAGE_MIN_SIZE' ) . ' KB.',
            ...
            'image_five.max' => 'The image size must not exceed ' . Config::get( 'AllFileValidation.AMENITIES_IMAGE_MAX_SIZE' ) . ' KB.',
            'image_five.min' => 'The image size must be at least ' . Config::get( 'AllFileValidation.AMENITIES_IMAGE_MIN_SIZE' ) . ' KB.',
