...
class RegisterController extends Controller {
    ...
    public function update(Request $request){
        ...
        $messages = [   
                        ...
                        // 'mobile_number.required' => 'Please enter mobile_number.',
                        // 'mobile_number.regex' => 'Please enter only mobile_numbers with 10-digit.',
    ...
    public function register(Request $request){
        ...
        $messages = [   
                        ...
                        // 'password.required' => 'Please enter password.',
                        // 'password.regex' => 'Password should be more than 8 mobile_numbers with atleast 1 capital letter,1 small letter, 1 mobile_number and 1 special character.',
                        // 'password_confirmation.same' => 'The password confirmation does not match.',
                        // 'password.min' => 'Please combination of mobile_number character of 8 char.',
                        // 'role_id.required' => 'Please select role type.',
                        // 'f_name.required' => 'Please enter first name.',
                        //  'f_name.regex' => 'Please  enter text only.',
                        // 'f_name.max'   => 'Please  enter first name length upto 255 character only.',
    ...
    public function updateProfile(Request $request){
        ...
        $messages = [   
                        ...
                        // 'email.email' => 'Please enter valid email.',
                        // 'password.required' => 'Please enter password.',
                        // 'mobile_number.regex' => 'Please enter 10 digit mobile_number.',
                    ];
        ...
        try {
            ...
            if ($validation->fails()) {
                ...
                if($register_user)
                {
                    ...
                    elseif((isset($request->password) && $request->password !== '') && ($request->mobile_number == $request->old_number)) {
            ...
            if ($validation->fails()) {
                ...
                if($otp->otp == $request->otp_number) {
                    ...
                    if($request->mobile_change =='yes') {
                        $update_data['mobile_number'] = $request->new_mobile_number;
                    }
