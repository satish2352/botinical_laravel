...
use App\Http\Services\Admin\Master\RoleServices;
use Validator;
class RoleController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('admin.pages.master.roles.list-role', compact('roles'));
        } catch (\Exception $e) {
            return $e;
        }
    }
    public function add()
    {
        try {
            $permissions = Permissions::where('is_active', true)
                ...
                ->get()
                ->toArray();
            return view('admin.pages.master.roles.add-role', compact('permissions'));
        } catch (\Exception $e) {
            return $e;
        }
    }
    ...
    public function show(Request $request)
    {
        try {
            ...
            return view('admin.pages.master.roles.show-role', compact('roles'));
        } catch (\Exception $e) {
            return $e;
        }
    }
    public function edit(Request $request)
    {
        try {
            ...
            return view('admin.pages.master.roles.edit-role', compact('user_data'));
        } catch (\Exception $e) {
            return $e;
        }
    }
