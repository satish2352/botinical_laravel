    ...
    public function getZoneArea(Request $request) {
        try {
            ...
            if ($language == 'hindi') {
                ...
                $data_output = $basic_query_object->select('id','english_name as name', 'english_description as description', 'english_audio_link as audio_link', 'english_video_upload as video_upload', 'image', 'latitude', 'longitude','image_two', 'image_three', 'image_four', 'image_five')->orderBy('english_name', 'asc');
            }
