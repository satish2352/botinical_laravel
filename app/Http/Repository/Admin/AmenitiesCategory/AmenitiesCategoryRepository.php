<?php
namespace App\Http\Repository\Admin\AmenitiesCategory;
...
class AmenitiesCategoryRepository  {
    ...
    {   
        ...
        try { 
            ...
            $dataOutput = CategoryAmenities::find($request->id);
...
public function updateOneCategory($request) {
    try {
        $data_output = CategoryAmenities::find($request); // Assuming $request directly contains the ID        
        if ($data_output) {
