                                        ...
                                        <div class="form-group-inner">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="@if (old('english_price')) {{ old('english_price') }}@else{{ $editData->english_price }} @endif"
                                                        id="english_price" name="english_price"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label for="hindi_price">नाम:</label>
                                                    <input type="text" class="form-control"
                                                        value="@if (old('hindi_price')) {{ old('hindi_price') }}@else{{ $editData->hindi_price }} @endif"
                                                        id="hindi_price" name="hindi_price"
                                                        placeholder="नाम दर्ज करें">
