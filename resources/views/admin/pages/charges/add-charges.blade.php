                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="all-form-element-inner">
                                    <form action="{{ route('store-charges') }}" method="POST" id="addDesignsForm"
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label for="english_price">Price :</label>
                                                    <input type="text" class="form-control" id="english_price"
                                                        name="english_price" placeholder="Enter price">
                                                    @if ($errors->has('english_price'))
                                                        <span class="red-text"><?php echo $errors->first('english_price', ':message'); ?></span>
                                                    @endif
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label for="hindi_price">कीमत :</label>
                                                    <input type="text" class="form-control" id="hindi_price"
                                                        name="hindi_price" placeholder="कीमत दर्ज करें">
                                                    @if ($errors->has('hindi_price'))
                                                        <span class="red-text"><?php echo $errors->first('hindi_price', ':message'); ?></span>
                                                    @endif
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="login-horizental cancel-wp pull-left">
                                                            <a href="{{ route('list-charges') }}" class="btn btn-white"
