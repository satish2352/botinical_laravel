                                                        ...
                                                        <select class="form-control mb-2" name="tree_plant_id"
                                                            ...
                                                            @foreach ($dataOutputTreePlant as $data)
                                                                <option value="{{ $data->id }}"
                                                                    @if ($tress->tree_plant_id == $data->id) {{ 'selected' }} @endif>
                                                                    {{ $data->english_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="hindi_name" id="hindi_name"
                                                            ...
                                                            value="@if (old('hindi_name')) {{ old('hindi_name') }}@else{{ $tress->hindi_name }} @endif" readonly>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="english_botnical_name"
                                                            ...
                                                            value=" @if (old('english_botnical_name')) {{ old('english_botnical_name') }}@else{{ $tress->english_botnical_name }} @endif" readonly>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="hindi_botnical_name"
                                                            ...
                                                            value="@if (old('hindi_botnical_name')) {{ old('hindi_botnical_name') }}@else{{ $tress->hindi_botnical_name }} @endif" readonly>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="english_common_name"
                                                            ...
                                                            value=" @if (old('english_common_name')) {{ old('english_common_name') }}@else{{ $tress->english_common_name }} @endif" readonly>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="hindi_common_name"
                                                            ...
                                                            value="@if (old('hindi_common_name')) {{ old('hindi_common_name') }}@else{{ $tress->hindi_common_name }} @endif" readonly>
