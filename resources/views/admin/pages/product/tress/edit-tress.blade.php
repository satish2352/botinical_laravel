                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            @if (old('english_description')){{ old('english_description') }}@else{{ $tress->english_description }}@endif
                                            </textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            @if (old('hindi_description')){{ old('hindi_description') }}@else{{ $tress->hindi_description }}@endif
                                            </textarea>
                                    ...
                                    <div id="englishaudio" >
                                        <audio controls >
                                            <source src="{{ Config::get('DocumentConstant.TRESS_VIEW') }}{{ $tress->english_audio_link }}"  accept="audio/*">
                                        </audio>
                                    </div>
                                ...
                                @endif
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div id="hindiaudio" >
                                                <audio controls >
                                                    <source src="{{ Config::get('DocumentConstant.TRESS_VIEW') }}{{ $tress->hindi_audio_link }}"  accept="audio/*">
                                                </audio>
                                            </div>
