...
<?php $data_permission = getPermissionForCRUDPresentOrNot('list-zone-area', session('permissions'));
    ?>
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Zone Area <span class="table-project-n">Data</span> Table</h1>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="{{ route('edit-zone-area', base64_encode($item->id)) }}"
    ...
    <form method="POST" action="{{ url('/delete-zone-area') }}" id="deleteform">
        @csrf
        <input type="hidden" name="delete_id" id="delete_id" value="">
    </form>
    <form method="POST" action="{{ url('/show-zone-area') }}" id="showform">
        @csrf
        <input type="hidden" name="show_id" id="show_id" value="">
    </form>
    <form method="POST" action="{{ url('/update-active-zone-area') }}" id="activeform">
        @csrf
