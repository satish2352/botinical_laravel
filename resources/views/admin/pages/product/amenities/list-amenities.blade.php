...
<?php $data_permission = getPermissionForCRUDPresentOrNot('list-amenities', session('permissions'));
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Amenities <span class="table-project-n">Data</span> Table</h1>
                                <div class="form-group-inner login-btn-inner row">
                                    <div class="col-lg-2">
                                        <div class="login-horizental cancel-wp pull-left">
                                            @if (in_array('per_add', $data_permission))
                                            <a href="{{ route('add-amenities') }}"><button
                                                    class="btn btn-sm btn-primary login-submit-cs" type="submit"
                                                    href="{{ route('add-amenities') }}">Add Amenities</button></a>
                                                    @endif
                                                </div>
                                    </div>
                                            ...
                                            @endif
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="{{ route('edit-amenities', base64_encode($item->id)) }}"
    ...
    <form method="POST" action="{{ url('/show-amenities') }}" id="showform">
        @csrf
        <input type="hidden" name="show_id" id="show_id" value="">
    </form>
    <form method="POST" action="{{ url('/update-active-amenities') }}" id="activeform">
        @csrf
