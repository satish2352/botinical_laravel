...
<?php $data_permission = getPermissionForCRUDPresentOrNot('list-flowers', session('permissions'));
    ?>
                                            ...
                                            @foreach ($flowers as $item)
                                                <tr>
                                                    ...
                                                    {{-- <td> <img class="img-size"
                                                            src="{{ Config::get('DocumentConstant.FLOWERS_VIEW') }}{{ $item->image }}"
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="{{ route('edit-flowers', base64_encode($item->id)) }}"
    ...
    <form method="POST" action="{{ url('/delete-flowers') }}" id="deleteform">
        @csrf
        <input type="hidden" name="delete_id" id="delete_id" value="">
    </form>
    <form method="POST" action="{{ url('/show-flowers') }}" id="showform">
        @csrf
        <input type="hidden" name="show_id" id="show_id" value="">
    </form>
    <form method="POST" action="{{ url('/update-active-flowers') }}" id="activeform">
        @csrf
