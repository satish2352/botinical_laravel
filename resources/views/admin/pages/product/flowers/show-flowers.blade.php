                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <label>{{ strip_tags($flowers->english_botnical_name) }}</label>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <label>{{ strip_tags($flowers->hindi_botnical_name) }}</label>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <label>{{ strip_tags($flowers->english_common_name) }}</label>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <label>{{ strip_tags($flowers->hindi_common_name) }}</label>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-lg-3 col-md-3 col-sm-3">
