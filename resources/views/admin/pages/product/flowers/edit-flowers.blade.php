        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="sparkline12-list">
                <div class=" " style="display: flex; justify-content:space-between">
                    <h3 class="page-title">Flowers
                    </h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background-color: #fff;">
                            <li class="breadcrumb-item"><a href="{{ route('list-flowers') }}">Flowers</a></li>
                ...
                <div class="sparkline12-graph">
                    <div class="basic-login-form-ad">
                        <div class="row">
                            ...
                            <form class="forms-sample" action="{{ route('update-flowers') }}" method="post" id="regForm"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            @if (old('english_description')){{ old('english_description') }}@else{{ $flowers->english_description }}@endif
                                            </textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            @if (old('hindi_description')){{ old('hindi_description') }}@else{{ $flowers->hindi_description }}@endif
                                            </textarea>
                                    ...
                                    <div id="englishaudio" >
                                        <audio controls >
                                            <source src="{{ Config::get('DocumentConstant.FLOWERS_VIEW') }}{{ $flowers->english_audio_link }}"  accept="audio/*">
                                        </audio>
                                    </div>
                                ...
                                @endif
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div id="hindiaudio" >
                                                <audio controls >
                                                    <source src="{{ Config::get('DocumentConstant.FLOWERS_VIEW') }}{{ $flowers->hindi_audio_link }}"  accept="audio/*">
                                                </audio>
                                            </div>
