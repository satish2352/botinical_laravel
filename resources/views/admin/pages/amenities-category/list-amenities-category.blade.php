...
<div class="data-table-area mg-tb-15">
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1>Amenities Category <span class="table-project-n">Data</span> Table</h1>
    ...
    <form method="POST" action="{{ url('/delete-amenities-category') }}" id="deleteform">
        @csrf
        <input type="hidden" name="delete_id" id="delete_id" value="">
    </form>
    <form method="POST" action="{{ url('/update-one-amenities-category') }}" id="activeform">
        @csrf
