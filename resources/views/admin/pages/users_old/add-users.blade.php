                        ...
                        <div class="card-body">
                            <form class="forms-sample" id="frm_register" name="frm_register" method="post" role="form"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="date_of_birth">Date of Birth</label>&nbsp<span class="red-text">*</span>
                                            <input type="text" class="form-control" name="date_of_birth" id="date_of_birth"
                                                placeholder="" value="{{ old('date_of_birth') }}">
                                            @if ($errors->has('date_of_birth'))
                                                <span class="red-text"><?php echo $errors->first('date_of_birth', ':message'); ?></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
