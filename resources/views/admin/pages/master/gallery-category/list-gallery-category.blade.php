...
<?php $data_permission = getPermissionForCRUDPresentOrNot('list-gallery-category', session('permissions'));
    ?>
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1>Gallery Category <span class="table-project-n">Data</span> Table</h1>
                                <div class="form-group-inner login-btn-inner row">
                                    <div class="col-lg-2" >
                                        <div class="login-horizental cancel-wp pull-left">
                                                <a href="{{ route('add-gallery-category') }}" ><button class="btn btn-sm btn-primary login-submit-cs" type="submit" href="{{route('add-gallery-category')}}">Add Gallery Category</button></a>
                                        </div>
                                    </div>
