...
<?php $data_permission = getPermissionForCRUDPresentOrNot('list-home', session('permissions'));
    ?>
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Home <span class="table-project-n">Data</span> Table</h1>
                                <div class="form-group-inner login-btn-inner row">
                                    <div class="col-lg-2">
                                        <div class="login-horizental cancel-wp pull-left">
                                            <a href="{{ route('add-home') }}"><button
                                                    class="btn btn-sm btn-primary login-submit-cs" type="submit"
                                                    href="{{ route('add-home') }}">Add Home Data</button></a>
                                        </div>
                                    </div>
                                            ...
                                            @foreach ($home as $item)
                                                <tr>
                                                    ...
                                                    <td> <img class="img-size"
                                                            src="{{ Config::get('DocumentConstant.HOME_DATA_VIEW') }}{{ $item->english_image }}"
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="{{ route('edit-home', base64_encode($item->id)) }}"
    ...
    <form method="POST" action="{{ url('/delete-home') }}" id="deleteform">
        @csrf
        <input type="hidden" name="delete_id" id="delete_id" value="">
    </form>
    <form method="POST" action="{{ url('/show-home') }}" id="showform">
        @csrf
        <input type="hidden" name="show_id" id="show_id" value="">
    </form>
    <form method="POST" action="{{ url('/update-active-home') }}" id="activeform">
        @csrf
