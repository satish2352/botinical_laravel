                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>About Us <span class="table-project-n">Data</span> Table</h1>
                                <div class="form-group-inner login-btn-inner row">
                                    <div class="col-lg-2">
                                        <div class="login-horizental cancel-wp pull-left">
                                            <a href="{{ route('add-aboutus') }}"><button
                                                    class="btn btn-sm btn-primary login-submit-cs" type="submit"
                                                    href="{{ route('add-aboutus') }}">Add About Us</button></a>
                                        </div>
                                    </div>
                                            ...
                                            @foreach ($aboutus as $item)
                                                <tr>
                                                    ...
                                                    <td> <img class="img-size"
                                                            src="{{ Config::get('DocumentConstant.ABOUTUS_VIEW') }}{{ $item->image }}"
