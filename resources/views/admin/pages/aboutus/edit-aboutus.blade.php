                ...
                <div class=" " style="display: flex; justify-content:space-between">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background-color: #fff;">
                            <li class="breadcrumb-item"><a href="{{ route('list-aboutus') }}">About Us</a></li>
                ...
                <div class="sparkline12-graph">
                    <div class="basic-login-form-ad">
                        <div class="row">
                            ...
                            <form class="forms-sample" action="{{ route('update-aboutus') }}" method="post" id="regForm"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="english_name" id="english_name"
                                                ...
                                                value=" @if (old('english_name')) {{ old('english_name') }}@else{{ $aboutus->english_name }} @endif">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="hindi_name" id="hindi_name"
                                                ...
                                                value="@if (old('hindi_name')) {{ old('hindi_name') }}@else{{ $aboutus->hindi_name }} @endif">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            @if (old('english_description')){{ old('english_description') }}@else{{ $aboutus->english_description }}@endif
                                            </textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            @if (old('hindi_description')){{ old('hindi_description') }}@else{{ $aboutus->hindi_description }}@endif
                                            </textarea>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <img id="english"
                                            src="{{ Config::get('DocumentConstant.ABOUTUS_VIEW') }}{{ $aboutus->image }}"
