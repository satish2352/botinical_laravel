                    ...
                    <div class=" " style="display: flex; justify-content:space-between">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb" style="background-color: #fff;">
                                <li class="breadcrumb-item"><a href="{{ route('list-aboutus-element') }}">About Us
                                        Element</a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="all-form-element-inner">
                                        <form class="forms-sample" action="{{ route('update-aboutus-element') }}"
...
{{ old('english_description') }}@else{{ $aboutuselement->english_description }}
@endif
                                            </textarea>
...
{{ old('hindi_description') }}@else{{ $aboutuselement->hindi_description }}
@endif
                                            </textarea>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        <label for="open_time">Open Time </label>&nbsp<span
                                                            class="red-text">*</span>
                                                        <input type="time" class="form-control mb-2" id="open_time"
                                                            name="open_time" placeholder="Enter the Open Time"
                                                            value="@if (old('open_time')) {{ old('open_time') }}@else{{ $aboutuselement->open_time }} @endif">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <div class="form-group">
                                                        <label for="close_time">Close Time </label>&nbsp<span
                                                            class="red-text">*</span>
                                                        <input type="time" class="form-control mb-2" id="close_time"
                                                            name="close_time" placeholder="Enter the Close Time"
                                                            value="@if (old('close_time')) {{ old('close_time') }}@else{{ $aboutuselement->close_time }} @endif">
